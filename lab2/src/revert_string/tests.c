...
void testRevertString(void) {
  ...
  char str_with_spaces[] = "String with space";
  ...
  CU_ASSERT_STRING_EQUAL_FATAL(str_with_spaces, "ecaps htiw gnirtS");
  ...
  CU_ASSERT_STRING_EQUAL_FATAL(str_with_even_chars_num, "dbca");
}
